NOTE: Module is still under active development, consider it Alpha quality.

This module enables Drupal 8 to authenticate users using Shibboleth, and assign
their roles based on group membership settings in the  UW Groups Web Service.
...
configured to expose the attribute "uwnetid" as the REMOTE_USER. In addition
it assumes that your UW CA provided certificates are located in /etc/ssl:
